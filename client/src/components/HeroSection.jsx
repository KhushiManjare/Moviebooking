...
>
  ...
  className="flex items-center gap-2 px-8 py-3 text-white text-base font-semibold bg-red-600 hover:bg-red-700 transition rounded-full cursor-pointer shadow-lg"
>
        Explore Movies
